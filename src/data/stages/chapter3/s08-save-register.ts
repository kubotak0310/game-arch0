...
export const stage8: Stage = {
  ...
  objective: { ja: 'CALL の後でも R3 が 5 のままになるよう、関数を修正せよ（R1 は 109 になる）', en: 'Modify the function so R3 remains 5 after CALL (R1 should be 109)' },

  initialMemory: [],
  initialSource: 'JMP main\n\n; この関数は内部で R3 を書き換える。\n; main の R3 を壊さないよう、関数の入口で保存し、出口で復元する必要がある。\ndo_work:\nMOV R3, 99\nADD R1, R1, R3\nRET\n\nmain:\nMOV R1, 10\nMOV R3, 5\nCALL do_work\n',

  successConditions: [
    { type: 'register', target: 'R1', expected: 109 },
